...
<body>
    ...
    <section class="section-contenido">
        <h1 class="title1">Nuestra quinta</h1>
        <div id="galeria" class="sliderIMG slider">
            <?php 
                for($i = 1; $i <= 13; $i++){
                    echo '<div><div><img src="img/quinta/'.$i.'.jpg" alt="Imagen '.$i.'"></div></div>';
                }
            ?>
        </div>
        <div id="descripcion">
        ...
        <!-- <div id="div-precio">
            <h1>Precio: $10.000 / día</h1>
            <h2>( mínimo 2 días )</h2>
        </div> -->
        <div id="div-boton">
            <a href="reservas.php?res=2" class="btn btnVerde">Ver días disponibles</a>
        </div>
    </section>
    ...
    <section class="section-ubicacion" style="background: url('img/fondo/fondoUbicacion4.jpg') no-repeat;background-size: cover;background-position: center bottom;">
        <div>
            ...
            <iframe id="mapa" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3392.124766856997!2d-60.829691585583966!3d-31.767082820479356!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzHCsDQ2JzAxLjUiUyA2MMKwNDknMzkuMCJX!5e0!3m2!1ses-419!2sar!4v1606174545881!5m2!1ses-419!2sar" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
        </div>
        <div>
